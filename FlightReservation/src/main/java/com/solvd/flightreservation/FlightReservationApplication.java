...
public class FlightReservationApplication {
	...
	// Reflection concept is used here
		try {
			...
			Constructor<?> constructor = flightReservationClass.getConstructor(String.class, String.class, String.class,
					String.class);

			// Generate flight reservations
			for (int i = 1; i <= 5; i++) {
				// Create a new instance of FlightReservation
				Object flightReservation = constructor.newInstance("Reservation" + i, "Passenger" + i, "Flight" + i,
						"CONFIRMED");
	...
	LOGGER.info("Number of cancelled :" + cancelCount);
		...
		LOGGER.info("*******Welcome to Fly Easy ********");
		...
		while (!exit) {
			...
			while (!exit) {
				...
				String reservationCode = TicketGenerator.generateReservationCode();
				...
				Booking booking = new Booking(sselectedFlight, selectedCabinClass, passengers,
